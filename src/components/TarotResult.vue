<template>
  <div class="w-full max-w-5xl flex flex-col gap-4 md:gap-8 mt-8 md:mt-12 z-20 pb-8 md:pb-12">
    ...
    <div class="p-5 md:p-8 bg-gradient-to-r from-[#0984E3]/20 to-[#00CEC9]/20 border border-[#00CEC9]/50 rounded-2xl md:rounded-3xl text-center shadow-lg">
      <h3 class="text-sm md:text-lg font-bold text-[#00CEC9] mb-3 tracking-widest uppercase">Kesimpulan Ramalan</h3>
      <p class="text-xs md:text-base text-[#F5F6FA] italic leading-relaxed">{{ dynamicSummary }}</p>
    </div>

    <button @click="$emit('reset')" class="mt-2 md:mt-4 px-6 py-2 md:px-8 md:py-3 text-xs md:text-sm text-[#00CEC9] font-bold uppercase border border-[#00CEC9] rounded-full hover:bg-[#00CEC9] hover:text-[#1A2026] transition-all self-center shadow-[0_0_15px_rgba(0,206,201,0.2)] hover:shadow-[0_0_25px_#00CEC9]">
      Baca Ulang
    </button>
  </div>
</template>
